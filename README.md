...
## Publishing Engine (v0.6.0)

The backend foundation adds workspace-scoped publishing APIs for drafts, version history, review, scheduling, and queue management.

The frontend package adds responsive Publishing workspace screens for the Content Library, Draft Editor, Review Queue, Publishing Calendar, Publishing Queue, Settings, and Social Connection Status.
...
**Status: Complete** ✅ — External publishing providers remain out of scope.

See `docs/API/PUBLISHING-BACKEND-FOUNDATION.md`, `docs/ARCHITECTURE/PUBLISHING-ENGINE.md`, `docs/ARCHITECTURE/PUBLISHING-PROCESSING.md`, `docs/QA/PUBLISHING-FRONTEND.md`, `docs/QA/PUBLISHING-PROCESSING.md`, `docs/RELEASES/V0.6.0-PACKAGE3-RELEASE-NOTES.md`, and `docs/RELEASES/PACKAGE3-POST-MORTEM.md`.
